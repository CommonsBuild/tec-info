...
[Vandana Shiva: Bill Gate’s Book Is Rubbish!](https://www.youtube.com/watch?v=3_8owv2dtP0)
...
I think the forum's TOS and Policies, etc. need a few edits -
...
Hi everybody. The seperation of governance rights from a crypto token is a challenge faced by numerous daos. I came across a project that enables exactly that, while scrolling through various gitcoin grant applications. It gets me pretty excited so I thought I'd share it here. Sunder Finance. Maybe there is collaboration potential here.
...
Idea - can we set up a 'where and when' chat channel, so that people can 1. share when they're going to be uncontactable or away from the TEC for a while (they're on holiday or they have a period where they need to focus on other things), and 2. if they're going to be visiting somewhere, they can share where and when and that might facilitate people meeting up in real life  @Vyvy-vi what do you think?
...
ryeder (they/them)
 ...
 If I started a book club on the book, *Race after technology* by Ruha Benjanmin:
...
Do you know about the DAO Book Club? I belive that Panvala will help sponsor new book club initiatives and they can be hosted here. We held our book club reading Elinor Ostrom's Govering the Commons there.
...
i am managing an event at an upcoming national hack-a-thon
...
i want to start the anti-giveth... it's called taketh. basically it's like giveth except we ask people for access to their financial information and then take everything in the account away. think 
[Pizza Business - Saturday Night Live](https://www.youtube.com/watch?v=pU8prtJUwHk)
...
cardano DOES need TEC's help! would be great to connect the two groups. there will be $500k rewarded to community projects via Catalyst (Cardano's shark tank incubator).
...
Hi Jose ️ @JoseK I just restarted one of my tasks welcoming new server entrants into orientation at TEC, but thought here would be a much more appropriate place for me to ping you.  ❤️ 
...
Hi TE Community. I wanted to share some of our latest work on TrueBlocks. We put this together permissionlessly (that is, unrelated to GitCoin):
...
I don't know if this is the right place to put this request for guidance... I also posted it in the Commons Stack Discord, but the server is surprisingly very quite nowadays. I spoke to some sensoricans and I propose to run an experiment with TEC to see how the tools can be applied to a concrete hardware project, the Greens for Good project for example
...
I gave a presentation at a new EcoVillage in CostaRica talking about #🌱｜commons-stack and recorded it for channel. Its about how to have a truly adaptive economic system through these changing times as the definition of value and our needs will drastically change from the old paradigm. 
[Holistic Value System for DAOs](https://www.youtube.com/watch?v=raznEnYsL2E&ab_channel=BeingUntamed)
...
Wanted to share an interesting token engineering application to combat climate crisis that was part of the Hyperledger Challenge. Worth thinking about what TEC community would advise in the next iteration of the prototype. See Methane certification demo: tracking emissions in the oil & gas supply chain - 
[Methane certification demo: tracking emissions in the oil & gas sup...](https://www.youtube.com/watch?v=fwAaTXdlPko&t=170s)
